...
test('stable builds pin verified service releases while rolling builds follow pre-release', () => {
  assert.equal(KOKOROBOX_SERVICE_STABLE_TAG, 'v0.6.1')
  assert.deepEqual(kokoroboxServiceAsset('win32', 'x64', 'stable'), {
    downloadURL:
      'https://github.com/amamiyakokoro/kokorobox-service/releases/download/v0.6.1/kokorobox-service-windows-amd64-v3.exe',
    filename: 'kokorobox-service-windows-amd64-v3.exe',
    sha256URL:
      'https://github.com/amamiyakokoro/kokorobox-service/releases/download/v0.6.1/kokorobox-service-windows-amd64-v3.exe.sha256',
    tag: 'v0.6.1',
    processRouter: {
      downloadURL:
        'https://github.com/amamiyakokoro/kokorobox-service/releases/download/v0.6.1/kokorobox-service-windows-amd64-v3-process-router.zip',
      filename: 'kokorobox-service-windows-amd64-v3-process-router.zip',
      sha256URL:
        'https://github.com/amamiyakokoro/kokorobox-service/releases/download/v0.6.1/kokorobox-service-windows-amd64-v3-process-router.zip.sha256'
    }
  })
