...
content += '\n<b>下载地址：</b>\n<b>Windows10/11：</b>\n'
content += `自动 UAC 版：<a href="${downloadUrl}/kokorobox-desktop-windows-${version}-x64-setup.exe">64 位</a> | <a href="${downloadUrl}/kokorobox-desktop-windows-${version}-arm64-setup.exe">ARM64</a>\n`
