...
const downloadUrl = `https://github.com/amamiyakokoro/KokoroBox-Desktop/releases/download/${tag}`
const latest = {
  version,
  tag,
  changelog
...
if (process.env.SKIP_CHANGELOG !== '1') {
  changelog += '\n### 下载地址：\n\n#### Windows10/11：\n\n'
  changelog += `- 自动 UAC 版：[64 位](${downloadUrl}/kokorobox-desktop-windows-${version}-x64-auto-elevate-setup.exe) | [ARM64](${downloadUrl}/kokorobox-desktop-windows-${version}-arm64-auto-elevate-setup.exe)\n\n`
