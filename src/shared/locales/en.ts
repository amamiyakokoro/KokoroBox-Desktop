...
export const messages: Readonly<Record<string, string>> = {
  ...
  'Switch default background': 'Switch default background',
  'Card background opacity': 'Card background opacity',
  ...
  Overview: 'Overview',
  'Observed public exit': 'Observed public exit',
  'Current proxy': 'Current proxy',
  'Public IP': 'Public IP',
  Routing: 'Routing',
  'Selected by routing rules': 'Selected by routing rules',
  ...
  'In about {0}': 'In about {0}',
  'Used traffic': 'Used traffic',
  'No recent traffic': 'No recent traffic',
  'Waiting for traffic': 'Waiting for traffic',
  '1 connection': '1 connection',
  'Subscription connection mode': 'Subscription connection mode',
  'Estimated from update interval': 'Estimated from update interval',
  'App routing {0}': 'App routing {0}',
  'Auto update off': 'Auto update off',
  'Update due': 'Update due',
  'Next update {0}': 'Next update {0}',
  'Top active app': 'Top active app',
  'Recently observed app': 'Recently observed app',
  'Latest sample': 'Latest sample',
  'Last 1 second': 'Last 1 second',
  'Last {0} seconds': 'Last {0} seconds',
  'Last observed': 'Last observed',
  'Last observed application; no current rate.': 'Last observed application; no current rate.',
  'No application activity yet': 'No application activity yet',
  '{0} s sample': '{0} s sample',
  'Connection rates use a separate {0} s sample.': 'Connection rates use a separate {0} s sample.',
  'App routing ({0})': 'App routing ({0})',
  '{0} active route': '{0} active route',
  ...
  '{0} this session': '{0} this session',
  'Mihomo runtime': 'Mihomo runtime',
  ...
  'KokoroBox Service requires approval.': 'KokoroBox Service requires approval.',
  'KokoroBox Service is unavailable.': 'KokoroBox Service is unavailable.',
  ...
  'Choose Home background image': 'Choose Home background image',
  Images: 'Images',
  'Failed to decode background image': 'Failed to decode background image',
  'Invalid or oversized background image': 'Invalid or oversized background image',
  'Background image is too large': 'Background image is too large',
  'Background image must be PNG, JPEG, or WebP': 'Background image must be PNG, JPEG, or WebP',
  General: 'General',
  Display: 'Display',
  ...
  'DNS and packet handling': 'DNS and packet handling',
  'DNS behavior': 'DNS behavior',
  'Fake IP settings': 'Fake IP settings',
  'DNS servers': 'DNS servers',
  'DNS routing': 'DNS routing',
  'Domain or rule': 'Domain or rule',
  'Address or value': 'Address or value',
  'Advanced DNS settings': 'Advanced DNS settings',
  'Sniffing behavior': 'Sniffing behavior',
  'Protocol ports': 'Protocol ports',
  'Sniffing exceptions': 'Sniffing exceptions',
  'Settings categories': 'Settings categories',
  'Scroll settings categories left': 'Scroll settings categories left',
  ...
  'Search proxy groups': 'Search proxy groups',
  'Search routing rules': 'Search routing rules',
  'Search rule collections': 'Search rule collections',
  'No proxy groups match this search.': 'No proxy groups match this search.',
  'No rule collections match this search.': 'No rule collections match this search.',
  'No rule collections yet': 'No rule collections yet',
  ...
  'Restart KokoroBox to apply the service repair.':
    'Restart KokoroBox to apply the service repair.',
  ...
  'You have unsaved changes in {0}.': 'You have unsaved changes in {0}.',
  ...
  '{0} items': '{0} items',
  '+ {0} more': '+ {0} more',
  'No bypass entries': 'No bypass entries',
  ...
  'System proxy operation failed': 'System proxy operation failed',
