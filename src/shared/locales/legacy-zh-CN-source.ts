// Temporary compatibility map for call sites that still use Simplified Chinese source messages.
export const messages: Readonly<Record<string, string>> = {
  ...
  复制环境变量类型: 'Copy environment variable format',
  复制规则: 'Copy rule',
  复古: 'Retro',
  外观设置: 'Appearance',
  ...
  环境变量类型: 'Environment variable type',
  ...
  自定义: 'Custom',
  抗污染: 'Anti-pollution',
  '虚假 IP 过滤模式': 'Fake-IP filter mode',
  黑名单: 'Blacklist',
  白名单: 'Whitelist',
  规则: 'Rules',
  ...
  '延迟查询备用 DNS': 'Query fallback DNS lazily',
