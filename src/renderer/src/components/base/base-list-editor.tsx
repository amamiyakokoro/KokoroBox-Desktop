        ...
        {displayed.map((entry, idx) => {
          ...
          const validation: ValidationResult =
            typeof rawValidation === 'boolean'
              ? { ok: rawValidation, error: rawValidation ? undefined : tr('Invalid format') }
              : rawValidation
          ...
          const validation1: ValidationResult =
            typeof rawValidation1 === 'boolean'
              ? { ok: rawValidation1, error: rawValidation1 ? undefined : tr('Invalid format') }
              : rawValidation1
          ...
          const validation2: ValidationResult =
            typeof rawValidation2 === 'boolean'
              ? { ok: rawValidation2, error: rawValidation2 ? undefined : tr('Invalid format') }
              : rawValidation2
