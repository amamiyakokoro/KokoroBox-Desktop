      ...
      >
        ...
        <div className="px-3 py-2 grid grid-cols-[auto_1fr] gap-x-2 gap-y-1.5 items-center">
          ...
          <Chip
            ...
            size="sm"
          >
            {proxy.alive ? tr('Online') : tr('Offline')}
          </Chip>
          ...
          {proxy.uot !== undefined && (
            <>
              ...
              <Chip
                ...
                size="sm"
              >
                {proxy.uot ? tr('Enabled') : tr('Off')}
              </Chip>
            </>
          )}
          {proxy.interface && (
            <>
              <span className="text-[10px] text-muted">{tr('Outbound interface')}</span>
          ...
          {group?.now && !group?.fixed && (
            <>
              <span className="text-[10px] text-muted">{tr('Current selection')}</span>
          ...
          {group?.fixed && (
            <>
              <span className="text-[10px] text-muted">{tr('Fixed selection')}</span>
              <span className="text-[10px] flag-emoji text-muted justify-self-end truncate">
                {group.fixed}
              </span>
            </>
        ...
        <div className="px-3 pt-2 pb-2.5">
          <span className="text-[10px] text-muted block mb-1.5">{tr('Latency history')}</span>
          {history.length > 0 ? (
            ...
            <span className="text-[10px] text-muted/50">{tr('No records')}</span>
          )}
        </div>
      </Surface>
    </div>,
