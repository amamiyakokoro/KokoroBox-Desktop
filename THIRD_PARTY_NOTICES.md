...
KokoroBox includes or references the components below, each under its own license.
...
| [Cloudflare Speedtest](https://github.com/cloudflare/speedtest)             | Measurement reference         | MIT                    | [License](licenses/LICENSE.CloudflareSpeedtest) | `LICENSE.CloudflareSpeedtest`             |
...
Cloudflare measurements use the speed.cloudflare.com endpoints directly. The SDK is
not bundled; its reference license backup is retained.
